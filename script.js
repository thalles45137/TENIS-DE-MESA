...
startImage.src = 'caminho/para/sua/imagem.jpg';  // Substitua pelo caminho correto da sua imagem
...
function drawStartScreen() {
    ...
    input.style.left = `${canvas.width / 1 - 180}px`;
    ...
    startButton.innerText = 'Começar';
    startButton.style.position = 'absolute';
    startButton.style.left = `${canvas.width / 1 - 140}px`;
